...
export const bookingsApi = {
  ...
  // Note: /api/admin/bookings/stats not available in backend - use /api/admin/analytics instead
...
export const settingsApi = {
  ...
  // Note: Nested settings endpoints (general, notifications, security, platform) not available
  // Use get() and update() instead
